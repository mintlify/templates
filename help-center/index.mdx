...
<div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-12 lg:py-16">
  ...
  <div className="flex flex-col gap-4">
    <h3 className="text-lg font-semibold text-gray-900 dark:text-zinc-50">Featured guides</h3>
    <Columns cols={3}>
      <Card
        horizontal
        icon="rocket"
  ...
  <div className="flex flex-col gap-4">
    <h3 className="text-lg font-semibold text-gray-900 dark:text-zinc-50">All guides</h3>
    <Columns cols={3}>
    <Card
      title="Workspace"
      icon="users"
  ...
  <div className="flex flex-col gap-2">
    <h3 className="text-lg font-semibold text-gray-900 dark:text-zinc-50">Suggested articles</h3>
