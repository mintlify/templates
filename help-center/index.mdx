...
<div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-12 lg:py-16">
    ...
    <div className="flex w-full max-w-lg flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="flex flex-wrap justify-center gap-1">
          {['custom domain', 'deployment', 'web editor'].map((term) => (
            <button
              key={term}
              type="button"
              data-popular-search
  ...
  <div className="flex flex-col gap-4">
    ...
    <Columns cols={3}>
      ...
      >
        Account setup, billing, integrations, and your first deploy
      </Card>
      <Card horizontal icon="book-open" iconType="light" title="Product guides" href="/product">
        Dashboard, web editor, projects, and deployments
      </Card>
      <Card horizontal icon="life-buoy" iconType="light" title="Support & legal" href="/support">
        Contact support, status, troubleshooting, and legal docs
      </Card>
    </Columns>
  </div>
  ...
  <Columns cols={2} className="suggested-articles">
    ...
    <Card
      ...
      icon="globe"
      iconType="light"
      href="/getting-started/integrations/partners/custom-connector-template"
      cta="Read article"
    >
