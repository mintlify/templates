...
<div data-product-guide-index className="flex w-full flex-col gap-8">
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <a
      href="/analytics"
      className="flex flex-col gap-4 rounded-none border border-border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
    >
