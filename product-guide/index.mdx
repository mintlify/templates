...
<div data-product-guide-index className="flex w-full flex-col gap-8">
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    >
      <Icon icon="chart-column" color="var(--primary)" size={18} className="shrink-0" />
    ...
    <a
      ...
      className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
    >
      <Icon icon="code-xml" color="var(--primary)" size={18} className="shrink-0" />
      <div className="flex flex-col gap-1">
  ...
  <div className="flex flex-col gap-4">
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <a
        ...
        className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="users" color="var(--primary)" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
      ...
      <a
        ...
        className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="database" color="var(--primary)" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
      ...
      <a
        ...
        className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="building-2" color="var(--primary)" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
      ...
      <a
        ...
        className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="layout-dashboard" color="var(--primary)" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
      ...
      <a
        ...
        className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="webhook" color="var(--primary)" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
      ...
      <a
        ...
        className="flex flex-col gap-4 rounded-none border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="calendar-clock" color="var(--primary)" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
