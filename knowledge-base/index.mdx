...
<div className="mx-auto flex w-full max-w-[720px] flex-col gap-12 px-4 py-10 lg:gap-14 lg:py-16">
  ...
  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
    ...
    >
      <div
        className="kb-feature-card relative flex h-[170px] items-center justify-center overflow-hidden rounded-2xl ring-1 ring-gray-100 transition group-hover:ring-gray-200 dark:ring-white/[0.08] dark:group-hover:ring-white/15"
        style={{
          "--kb-card-bg": 'url("/images/sample-texture-1.png")',
        }}
      >
    ...
    >
      <div
        className="kb-feature-card relative flex h-[170px] items-center justify-center overflow-hidden rounded-2xl ring-1 ring-gray-100 transition group-hover:ring-gray-200 dark:ring-white/[0.08] dark:group-hover:ring-white/15"
        style={{
          "--kb-card-bg": 'url("/images/sample-texture-2.png")',
        }}
      >
        <div className="relative flex items-center justify-center">
