---
title: "Home"
description: "Onboarding guides, HR policies, IT help, and engineering docs for the Mintlify team."
mode: custom
---
  ...
  <div className="flex flex-col items-center gap-6">
    <div className="flex max-w-[480px] flex-col gap-2 text-center">
      ...
      <p className="text-balance text-base text-gray-600 dark:text-gray-400">
        Your go-to reference for how things work at Mintlify — onboarding, HR, IT, policies, and engineering. Search with <kbd>⌘</kbd> <kbd>K</kbd>.
      </p>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
    ...
    >
      ...
      <div className="flex flex-col gap-1 pt-4">
        ...
        <span className="text-sm leading-5 text-gray-600 dark:text-gray-400">
          Accounts to activate, tools to set up, and people to meet before end of day one.
        </span>
      </div>
    </a>
    ...
    >
      ...
      <div className="flex flex-col gap-1 pt-4">
        ...
        <span className="text-sm leading-5 text-gray-600 dark:text-gray-400">
          Which tools you'll use at Mintlify, how to get access, and what to do when something is missing.
        </span>
      </div>
    </a>
  </div>
